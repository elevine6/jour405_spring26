...
ANSWER HERE
It is not normal, it looks skewed right. Most salaries are clustered between about 60,000 and 120,000.
...
The data follows the empirical rule because about 68% of the data are within 1 SD, 95% within 2 SD, and nearly all are within 3 SD, which matches the empirical rule for a normal distribution. This means the data is normally distributed.
...
ANSWER HERE
The probability with pnorm was 1.3% off from the actuak approximation, so there would be an 18% chance that a randomly selected employee makes more than $150,000. Pnorm used a normal curve to calculate the data, but the white house data. 
...
ANSWER HERE
Less people make between $80,000-$120,000 than expected. More employees make more than $120,000 a year than expected. 
...
ANSWER HERE
White House Employees making six figures

The average salary at the White House is $111,321 a year.

I would want to compare these probabilities to average salaries at other government facilities, like in the FBI or the CIA. I would want to talk to those employers about salaries. 
