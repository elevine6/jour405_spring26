...
There is no correlation between goal differential and fouls according to the correlation calculation. You can tell from the scatterplot because it is a horizontal line. 


### Task 7: Choose variable and repeat the steps in Tasks 4-5, then describe results
```{r}
...
```
There is a correlation between shots on goal and goal differential as the more shots on goal, the higher the goal differential. 
