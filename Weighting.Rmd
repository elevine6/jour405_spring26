...
0.23 would mean that the respondent is overrepresented, and 3.04 means that a respondent is underrepresented.
3. Why might some respondents be weighted more heavily than others?
This reduces sample bias. 
...
This makes it harder to reach this certain group of people and understand them. 
...
I think these differences exist because the weighted results adjust the same to reflect the population. The unweighted is who did not respond. 
