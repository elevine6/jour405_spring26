...
```{r}
#loading data
pg_crime = read.csv("/Users/emmalevine/Downloads/pg_crime_totals_2024.csv")

#preview data via glimpse command
glimpse(pg_crime)
```
...
ANSWER HERE
Residential robberies were by far the lowest crime throughout 2024. Homicides and B&E were also relatively low. These are probably less important than other crimes, such as accidents or theft from auto. Theft from auto and accidents are more important because the totals were consistently high throughout the year. This might make it harder to summarize the data because other crimes were also high, such as theft and auto stolen. 
...
The highest average number of incidents in a month are accidents, at 481.3 per month. The second highest average of incidents is auto stolen, at 399.16 per month. The lowest is residential robbery and the second lowest is homicide. This means most incidents are car accidents, most likely. I was surprised that sex offenses were as low as they were, because I feel like the fact that UMD being part of PG county would make that number go up. 
...
The percentage change decreases for almost all the categories, especially B&E. However, some crimes increase in August, such as commercial robbery. I think the pattern here is that when students come back to school in August, some crimes may increase, such as commercial robbery. This disproves the theory that crime happens more in the summer, because it only really happens when there is a surge of students back on campus in August.
...
Commercial robberies increase by 43.8% in August in Prince George's County, Maryland. 

The fall semester at the University of Maryland begins towards the end of August, leading to more students on campus in August. This can often lead to more crimes committed in the area. Additionally, students may be excited to be back at school and make poor decisions because of this. 
